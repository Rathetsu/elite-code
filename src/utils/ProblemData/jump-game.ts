...
export const testingFunctionJumpGame = (fun: any) => {
  try {
    const tests = [
      [2, 3, 1, 1, 4],
      [3, 2, 1, 0, 4],
    ...
    console.log("Jump Game testing function error", error);
    throw new Error(error);
  }
};

const startingCodeJumpGameJS = `function canJump(nums) {
...
export const jumpGame: Problem = {
  ...
  testingFunction: testingFunctionJumpGame,
  startingCode: startingCodeJumpGameJS,
  startingFunctionName: "function canJump(",
};
